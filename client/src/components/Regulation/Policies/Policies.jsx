...
const AccordionSummary = styled((props) => (
  <MuiAccordionSummary
    expandIcon={<ArrowForwardIosSharpIcon sx={{ fontSize: "0.9rem", color: "#1F2649" }} />}
    {...props}
  />
))(({ theme }) => ({
  backgroundColor:
      ...
      <h3>Policies</h3>
        ...
        >
          <AccordionSummary aria-controls="panel1d-content" id="panel1d-header">
            <Typography className={styles.title}>POLICIES AND DOCUMENTATION</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography >
              <ul className={styles.list}>
                ...
                <li>
                  <a href={Pdf5}>Sanus Refund and Cancellation Policy  {">"}</a>
                </li>
                <li>
                  <a href={Pdf6}>Sanus Financial Advisory and Intermediary Services Act Disclosure{">"} </a>
                </li>
                <li>
